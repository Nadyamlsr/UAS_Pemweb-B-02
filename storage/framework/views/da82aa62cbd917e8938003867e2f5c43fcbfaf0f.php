...
<?php
/****
* View untuk datatable role
* CRUD Master role 
* role adalah admin, customer, dan guest
****/
?>
	...
	var KTDatatablesDataSourceAjaxServer = function() {
		...
		var initTable1 = function() {
			...
			table.DataTable({
				...
				serverSide: true,
				order : [],
				ajax: { url  : alamat + '/role/datatables',
						type : 'POST',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WWW\hasbiproject\resources\views/pages/role.blade.php ENDPATH**/ ?>